...
function run(b, message, paint, noisy, plexers) {
  ...
  data.split('').forEach(function (v, i) {
    ...
    oscillators[i % oscillators.length].frequency.setValueAtTime(v == '1' ? high + i % oscillators.length * SHIFT : low + i % oscillators.length * SHIFT, startTime);
  });
  ...
  oscillators[0].onended = function () {
    ...
    paintOutput(_.weave.apply(_, out));
    try {
...
},{"binary-to-string":2,"lodash-contrib":17,"string-to-binary":19}],2:[function(require,module,exports){
...
},{"./_.collections.walk.js":3,"./_.function.arity.js":4,"./_.function.combinators.js":5,"./_.function.dispatch.js":6,"./_.function.iterators.js":7,"./_.function.predicates.js":8,"./_.object.builders.js":9,"./_.object.selectors.js":10,"./_.util.operators.js":11,"./_.util.strings.js":12,"./_.util.trampolines.js":13,"./common-js/_.array.builders.js":14,"./common-js/_.array.selectors.js":15,"./common-js/_.util.existential.js":16,"lodash":18}],18:[function(require,module,exports){
(function (global){
/**
 * @license
